inputN = input("addade mored nazar ra vared konid : ")
result = ""
...
if intN > 10**61:
    print("khata: addade mored nazar shoma az mahdoode moshakhas shode baraye in barname kharej mibashad ")
    quit()

yekan = ["", "yek", "do","se", "char", "panj", "sish", "haft", "hasht", "noh"]
dahha = ["dah", "yazdah", "davazdah", "sizdah", "chardash", "ponzdah", "shonzdah", "hefdah", "hejdah", "nozdah"]
tabist = yekan + dahha
dahgan = ["", "dah", "bist", "si", "chel", "panjah", "shast", "haftad", "mashtad", "navad"]
sadgan = ["", "saad", "devist", "sisad", "charsad", "ponsad", "sheshsad", "haftsad", "hashtsad", "nohsad"]
adadbozorg = {3: "hezaar", 6: "million", 9: "millyard", 12: "trillion",
